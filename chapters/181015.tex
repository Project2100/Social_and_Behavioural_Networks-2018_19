...
\section{181022}
	...
	Before proving, greedy algorithm, parameterized by f, X and k: trovare k sottoinsiemi di X che massimizzano f
...
\section{181024}
	...
	if $f_1, ..., f_k \in 2^X \to \mathbb{R} \text{ are submodular}, \alpha_1, ..., \alpha_k \geq 0 \Rightarrow \sum_{i=1}^{k}\alpha_i f_i \text{ is submodular }$
	...
	if f is submodular, nonnegative and monotone, then:
	\[
		f(S_K)\geq(1-1/e)max_{S \in \binom{X}{K}}f(S)
	\]
