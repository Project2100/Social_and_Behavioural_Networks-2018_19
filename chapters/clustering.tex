...
\begin{defn}[Minimum k-means]\label{defn:k-means}
...
The following modification by Arthur-Vassilitski guaranties that the algorithm will perform well in any case.
